...
<div className="profile-name-patnumber">
    <p>name:test</p>
    <p>surname:test</p>
    <p>patient num:1234</p>
</div>

</div>

<div className="profile-ailment">
    <p>ailment: <br /> a rash of red, itchy spots that turn
into fluid-filled blisters They then crust over to
form scabs which eventually drop off.</p>
</div>
